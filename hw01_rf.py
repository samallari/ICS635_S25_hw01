...
rf_depth_none = RandomForestClassifier() # default max_depth=None
rf_depth_1 = RandomForestClassifier(max_depth=1)
rf_depth_5 = RandomForestClassifier(max_depth=5)
rf_depth_10 = RandomForestClassifier(max_depth=10)
rf_depth_25 = RandomForestClassifier(max_depth=25)

# varying min sample split
rf_min_2 = RandomForestClassifier() # default min_samples_split=2
rf_min_5 = RandomForestClassifier(min_samples_split=5)
rf_min_10 = RandomForestClassifier(min_samples_split=10)
rf_min_25 = RandomForestClassifier(min_samples_split=25)
rf_min_30 = RandomForestClassifier(min_samples_split=30)
